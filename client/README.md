...
```sh
npm install @tanstack/react-query@4.29.5 \@tanstack/react-query-devtools@4.29.6 \axios@1.3.6 \dayjs@1.11.7 \react-icons@4.8.0 \react-router-dom@6.10.0 \react-toastify@9.1.2 \recharts@2.5.0 \styled-components@5.3.10 \ --legacy-peer-deps
...
- npm info react-router-dom version(tell you what version/number)
